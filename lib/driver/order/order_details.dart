                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Full Address:",
                          style:
                              textStyle15.copyWith(fontWeight: FontWeight.bold),
                        ),
                        Row(
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                ...
                                final String googleMapsUrl =
                                    "comgooglemaps://?center=${driver.orderDetails.address.latitude},${driver.orderDetails.address.longitude}";
                                final String appleMapsUrl =
                                    "https://maps.apple.com/?q=${driver.orderDetails.address.latitude},${driver.orderDetails.address.longitude}";
                        ...
                        Text(
                          "Building: ${driver.orderDetails.address.buildingName}",
                          style: textStyle15,
                        ),
                        Text(
                          "Floor: ${driver.orderDetails.address.floorNumber}",
                          style: textStyle15,
                        ),
                        Text(
                          "Contact: ${driver.orderDetails.phoneNumber}",
                          style: textStyle15,
                        ),
                        const SizedBox(
                          height: 20,
                        ...
                        ListView.builder(
                            ...
                            itemCount:
                                driver.orderDetails.checkListItems.length,
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Expanded(
                                          child: Text(
                                        "${driver.orderDetails.checkListItems[index].item}",
                                        style: textStyle15,
                                      )),
                                      Checkbox(
                                          value: driver.orderDetails
                                              .checkListItems[index].isDone,
                                          onChanged: (val) async {
                                            bool success = true;
                                            if (!driver.orderDetails
                                                .checkListItems[index].isDone) {
                                              showDialog(
                                                  context: context,
                                                  builder: (context) {
                          ...
                          child: Row(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(16.0),
                                child: Text(
                                  "${driver.orderDetails.address.description}",
                                  style: textStyle15,
                                ),
                              ),
                            ],
                                  ...
                                  builder: (context) {
                                    return CustomAlertDialog(
                                        ...
                                        confrimBtnFn: () async {
                                          ...
                                          Navigator.of(context).pop();
                                          success =
                                              await driver.setDriverOrderStatus(
                                                  widget.orderId, id);
                                          getData();
                            ...
                            child: Text(
                              status == orderStatus.onTheWay
                                  ...
                                  : status == orderStatus.twoMinutesToDeliver
                                      ...
                                      : "On the way",
                              style: TextStyle(
                                  fontFamily: "BerlinSansFB", fontSize: 15),
                            ),
